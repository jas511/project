...
class returns:
    def __init__(self):
        ...
        img1=Image.open(r"C:\Users\jasle\OneDrive\Pictures\Screenshots\Screenshot 2023-09-24 122528.png")
        ...
        self.userEntry.place(x = 690, y = 350,height=40,width=400) 
        ...
        self.passEntry.place(x = 690, y = 620,height=40,width=400)

        self.loginBtn = Button(self.root, text = 'RETURN',font=('sans-serif',13)) 
        self.loginBtn.place(x = 800, y = 720,width=100)
        ...
        self.loginBtn.place(x = 1360, y = 0,width=100)
